...
from pose_estimation.utils.pose_utils import fliplr_joints, transform_joint_to_other_db
...
def generate_patch_image(cvimg, bbox, do_flip, scale, rot, do_occlusion):
    ...
    # cv2.imshow('bbox', img[int(bbox[1]):int(bbox[1]+bbox[3]), int(bbox[0]):int(bbox[0]+bbox[2]), :])
