...
from pose_estimation.utils.pose_utils import world2cam, cam2pixel, pixel2cam, rigid_align, process_bbox
import cv2
import random
import json
from pose_estimation.utils.vis import vis_keypoints, vis_3d_skeleton
...
class Human36M:
    def __init__(self, data_split):
        ...
        self.img_dir = osp.join('/', 'Data', '3D_pose_estimation_dataset', 'Human3.6M', 'images')
        self.annot_path = osp.join('/', 'Data', '3D_pose_estimation_dataset', 'Human3.6M', 'annotations')
        self.human_bbox_root_dir = osp.join('/', 'Data', '3D_pose_estimation_dataset', 'Human3.6M', 'bbox_root', 'bbox_root_human36m_output.json')
