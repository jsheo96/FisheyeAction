...
class MuPoTS:
    def __init__(self, data_split):
        ...
        self.img_dir = osp.join('/', 'Data', '3D_pose_estimation_dataset', 'MuPoTS', 'data', 'MultiPersonTestSet')
        self.test_annot_path = osp.join('/', 'Data', '3D_pose_estimation_dataset', 'MuPoTS', 'data', 'MuPoTS-3D.json')
        self.human_bbox_root_dir = osp.join('/', 'Data', '3D_pose_estimation_dataset', 'MuPoTS', 'bbox_root', 'bbox_root_mupots_output.json')
