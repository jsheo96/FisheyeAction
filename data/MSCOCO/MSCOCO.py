...
class MSCOCO:
    def __init__(self, data_split):
        ...
        self.img_dir = osp.join('/','Data', '3D_pose_estimation_dataset', 'MSCOCO', 'images')
        self.train_annot_path = osp.join('/','Data', '3D_pose_estimation_dataset', 'MSCOCO', 'annotations', 'person_keypoints_train2017.json')
        self.test_annot_path = osp.join('/','Data', '3D_pose_estimation_dataset', 'MSCOCO', 'annotations', 'person_keypoints_val2017.json')
        self.human_3d_bbox_root_dir = osp.join('/','Data', '3D_pose_estimation_dataset', 'MSCOCO', 'bbox_root', 'bbox_root_coco_output.json')
