...
class MuCo:
    def __init__(self, data_split):
        ...
        self.img_dir = osp.join('/', 'Data', '3D_pose_estimation_dataset', 'MuCo', 'data')
        self.train_annot_path = osp.join('/', 'Data', '3D_pose_estimation_dataset', 'MuCo', 'data', 'MuCo-3DHP.json')
        self.joint_num = 21
